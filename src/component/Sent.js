...
<header className="play">
    ...
    <NavLink className="nav-link active " to="/sent">Sent Request</NavLink>
    </li>
  </ul>
              </div>
            </div>
...
<div className="main">
    ...
    <div class="myfriends">
     ...
     <div class="user_avel">
       <a href="#">
        <img src="assets/img/usericon.png"  alt="av"/> <span><strong>Vedpal</strong></span> <span class="av pull-right cen">  Panding  </span>
        </a>
      </div>
   <div class="user_avel">
       <a href="#">
        <img src="assets/img/usericon.png"  alt="av"/> <span><strong>Vedpal</strong></span> <span class="av pull-right acp">  Accepted </span>
        </a>
      </div>
      <div class="user_avel">
       <a href="#">
      ...
      <div class="user_avel">
       <a href="#">
        <img src="assets/img/usericon.png"  alt="av"/> <span><strong>Vedpal</strong></span> <span class="av pull-right acp">  Panding  </span>
        </a>
      </div>
      <div class="user_avel">
       <a href="#">
